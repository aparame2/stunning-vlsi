...
clear;
input_sample_rate = 1.0E06; % Hz
% x=1601332245;

plaintext_hex1 = {'32' '43' 'f6' 'a8' '88' '5a' '30' '8d' '31' '31' '98' 'a2' 'e0' '37' '07' '34'};
plaintext_hex2 = {'32' '43' 'f6' 'a8' '88' '5a' '30' '8d' '31' '31' '98' 'a2' 'e0' '37' '07' '34'};

x1 = hex2dec (plaintext_hex1);
x2 = hex2dec (plaintext_hex2);
x=[x1; x2];


roundkey_hex1 = { '2b' '7e' '15' '16' '28' 'ae' 'd2' 'a6' 'ab' 'f7' '15' '88' '09' 'cf' '4f' '3c'};
roundkey_hex2 = { '2b' '7e' '15' '16' '28' 'ae' 'd2' 'a6' 'ab' 'f7' '15' '88' '09' 'cf' '4f' '3c'};

y1 = hex2dec (roundkey_hex1);
y2 = hex2dec (roundkey_hex2);
y=[y1;y2];
...
b=['00';'02';'04';'06';'08';'0a';'0c';'0e';'10';'12';'14';'16';'18';'1a';'1c';'1e';'20';'22';'24';'26';'28';'2a';'2c';'2e';'30';'32';'34';'36';'38';'3a';'3c';'3e';'40';'42';'44';'46';'48';'4a';'4c';'4e';'50';'52';'54';'56';'58';'5a';'5c';'5e';'60';'62';'64';'66';'68';'6a';'6c';'6e';'70';'72';'74';'76';'78';'7a';'7c';'7e';'80';'82';'84';'86';'88';'8a';'8c';'8e';'90';'92';'94';'96';'98';'9a';'9c';'9e';'a0';'a2';'a4';'a6';'a8';'aa';'ac';'ae';'b0';'b2';'b4';'b6';'b8';'ba';'bc';'be';'c0';'c2';'c4';'c6';'c8';'ca';'cc';'ce';'d0';'d2';'d4';'d6';'d8';'da';'dc';'de';'e0';'e2';'e4';'e6';'e8';'ea';'ec';'ee';'f0';'f2';'f4';'f6';'f8';'fa';'fc';'fe';'1b';'19';'1f';'1d';'13';'11';'17';'15';'0b';'09';'0f';'0d';'03';'01';'07';'05';'3b';'39';'3f';'3d';'33';'31';'37';'35';'2b';'29';'2f';'2d';'23';'21';'27';'25';'5b';'59';'5f';'5d';'53';'51';'57';'55';'4b';'49';'4f';'4d';'43';'41';'47';'45';'7b';'79';'7f';'7d';'73';'71';'77';'75';'6b';'69';'6f';'6d';'63';'61';'67';'65';'9b';'99';'9f';'9d';'93';'91';'97';'95';'8b';'89';'8f';'8d';'83';'81';'87';'85';'bb';'b9';'bf';'bd';'b3';'b1';'b7';'b5';'ab';'a9';'af';'ad';'a3';'a1';'a7';'a5';'db';'d9';'df';'dd';'d3';'d1';'d7';'d5';'cb';'c9';'cf';'cd';'c3';'c1';'c7';'c5';'fb';'f9';'ff';'fd';'f3';'f1';'f7';'f5';'eb';'e9';'ef';'ed';'e3';'e1';'e7';'e5'];
c=hex2dec(b)';
multiplier2= c;


d=['00';'03';'06';'05';'0c';'0f';'0a';'09';'18';'1b';'1e';'1d';'14';'17';'12';'11';'30';'33';'36';'35';'3c';'3f';'3a';'39';'28';'2b';'2e';'2d';'24';'27';'22';'21';'60';'63';'66';'65';'6c';'6f';'6a';'69';'78';'7b';'7e';'7d';'74';'77';'72';'71';'50';'53';'56';'55';'5c';'5f';'5a';'59';'48';'4b';'4e';'4d';'44';'47';'42';'41';'c0';'c3';'c6';'c5';'cc';'cf';'ca';'c9';'d8';'db';'de';'dd';'d4';'d7';'d2';'d1';'f0';'f3';'f6';'f5';'fc';'ff';'fa';'f9';'e8';'eb';'ee';'ed';'e4';'e7';'e2';'e1';'a0';'a3';'a6';'a5';'ac';'af';'aa';'a9';'b8';'bb';'be';'bd';'b4';'b7';'b2';'b1';'90';'93';'96';'95';'9c';'9f';'9a';'99';'88';'8b';'8e';'8d';'84';'87';'82';'81';'9b';'98';'9d';'9e';'97';'94';'91';'92';'83';'80';'85';'86';'8f';'8c';'89';'8a';'ab';'a8';'ad';'ae';'a7';'a4';'a1';'a2';'b3';'b0';'b5';'b6';'bf';'bc';'b9';'ba';'fb';'f8';'fd';'fe';'f7';'f4';'f1';'f2';'e3';'e0';'e5';'e6';'ef';'ec';'e9';'ea';'cb';'c8';'cd';'ce';'c7';'c4';'c1';'c2';'d3';'d0';'d5';'d6';'df';'dc';'d9';'da';'5b';'58';'5d';'5e';'57';'54';'51';'52';'43';'40';'45';'46';'4f';'4c';'49';'4a';'6b';'68';'6d';'6e';'67';'64';'61';'62';'73';'70';'75';'76';'7f';'7c';'79';'7a';'3b';'38';'3d';'3e';'37';'34';'31';'32';'23';'20';'25';'26';'2f';'2c';'29';'2a';'0b';'08';'0d';'0e';'07';'04';'01';'02';'13';'10';'15';'16';'1f';'1c';'19';'1a'];
f=hex2dec(d)';
multiplier3= f;

inverse_s = {'52','09','6a','d5','30','36','a5','38','bf','40','a3','9e','81','f3','d7','fb', ...
...
isbox = hex2dec(inverse_s)';

%sbox= [99,124,119,123,242,107,111,197,48,1,103,43,254,215,171,118,202,130,201,125,250,89,71,240,173,212,162,175,156,164,114,192,183,253,147,38,54,63,247,204,52,165,229,241,113,216,49,21,4,199,35,195,24,150,5,154,7,18,128,226,235,39,178,117,9,131,44,26,27,110,90,160,82,59,214,179,41,227,47,132,83,209,0,237,32,252,177,91,106,203,190,57,74,76,88,207,208,239,170,251,67,77,51,133,69,249,2,127,80,60,159,168,81,163,64,143,146,157,56,245,188,182,218,33,16,255,243,210,205,12,19,236,95,151,68,23,196,167,126,61,100,93,25,115,96,129,79,220,34,42,144,136,70,238,184,20,222,94,11,219,224,50,58,10,73,6,36,92,194,211,172,98,145,149,228,121,231,200,55,109,141,213,78,169,108,86,244,234,101,122,174,8,186,120,37,46,28,166,180,198,232,221,116,31,75,189,139,138,112,62,181,102,72,3,246,14,97,53,87,185,134,193,29,158,225,248,152,17,105,217,142,148,155,30,135,233,206,85,40,223,140,161,137,13,191,230,66,104,65,153,45,15,176,84,187,22];


multiplier09 = {'00','09','12','1b','24','2d','36','3f','48','41','5a','53','6c','65','7e','77', ...
...
mul9 = hex2dec(multiplier09)';

multiplier11 = {'00','0b','16','1d','2c','27','3a','31','58','53','4e','45','74','7f','62','69', ...
...
mul11 = hex2dec(multiplier11)';

multiplier13 = {'00','0d','1a','17','34','39','2e','23','68','65','72','7f','5c','51','46','4b', ...
...
mul13 = hex2dec(multiplier13)';

multiplier14 = {'00','0e','1c','12','38','36','24','2a','70','7e','6c','62','48','46','54','5a', ...
...
mul14 = hex2dec(multiplier14)';

t = [0:31]'/input_sample_rate;

for i = 1:32
xt(i).time = t(i,:)';
xt(i).signals.values = x(i,:)';
xt(i).signals.dimensions = 1;
end

for i = 1:32
yt(i).time = t(i,:)';
yt(i).signals.values = y(i,:)';
yt(i).signals.dimensions = 1;
end
...
BlockName = 'pipelined';
set_param([BlockName '/From Workspace'],'VariableName','xt(1)')
set_param([BlockName '/From Workspace16'],'VariableName','yt(1)')
%set_param([BlockName '/To Workspace'],'VariableName','zt1')
%set_param([BlockName '/To Workspace'],'SaveFormat',['Structure With Time'])
for i=1:31
set_param([BlockName '/From Workspace' num2str(i)],'VariableName',['xt(' num2str(i+1) ')'])
set_param([BlockName '/From Workspace' num2str(i+16)],'VariableName',['yt(' num2str(i+1) ')'])
% set_param([BlockName '/To Workspace' num2str(i)],'VariableName',['zt' num2str(i+1)])
