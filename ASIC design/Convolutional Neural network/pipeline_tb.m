...
x = hex2dec (plaintext_hex)

roundkey_hex = { '2b' '7e' '15' '16' '28' 'ae' 'd2' 'a6' 'ab' 'f7' '15' '88' '09' 'cf' '4f' '3c'};
y = hex2dec (roundkey_hex);
...
BlockName = 'aes_impl_decrypt_smc';
